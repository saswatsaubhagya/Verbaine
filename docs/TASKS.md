...
**T1.2 Action definitions and prompts** — ✅ done (`d07edac`; build + test pass, real tokenizer confirms every instruction ≤ 120 tokens)
...
**T1.5 Undo buffer and toast** — ✅ done (`9c059a2`; build + test pass, 33 tests)
...
**T1.6 Error handling** — ✅ done (`967fe1f`; build + test pass, 43 tests)
